<template>
  <view :class="['dept-item', { 'dept-item--disabled': !multiple }]" @click="handlerItem">
    ...
    <div :class="['dept-item__right', 'db-btn', { 'dept-item__right--disabled': getDisabled() }]" @click.stop="handlerRight">
...
<script>
  ...
  export default {
    ...
    methods: {
      getDisabled() {
        return !this.data.childLen ? true : !this.multiple ? false : this.value
      },
      getChecked() {
